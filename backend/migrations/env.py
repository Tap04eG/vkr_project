...
# 1. Импорт Base из ваших моделей
...
# 3. Установка target_metadata для поддержки autogenerate
target_metadata = Base.metadata

# ... (остальной код функции run_migrations_offline остается без изменений)
