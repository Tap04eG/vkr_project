const tasks = [
    { id: 1, letters: ['Т', 'Р', 'О', 'Н'], targetLetter: 'Н', instruction: 'Найди букву: Н' },
    { id: 2, letters: ['У', 'Г', 'Д', 'Ж'], targetLetter: 'Г', instruction: 'Найди букву: Г' },
    { id: 3, letters: ['Щ', 'Э', 'Ю', 'Я'], targetLetter: 'Э', instruction: 'Найди букву: Э' },
    { id: 4, letters: ['Л', 'М', 'Н', 'Ц'], targetLetter: 'Л', instruction: 'Найди букву: Л' },
    { id: 5, letters: ['Х', 'Ъ', 'Е', 'Ё'], targetLetter: 'Ё', instruction: 'Найди букву: Ё' }
];
