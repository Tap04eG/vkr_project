...
### 🎉 Готово!
- Ваш сайт доступен по адресу: **http://127.0.0.1:8000**
- Документация API (Swagger): **http://127.0.0.1:8000/docs**

### 🌍 Публикация в интернете (Ngrok)
Поскольку фронтенд и бэкенд работают на одном порту, для доступа из интернета достаточно одной команды в новом терминале:
```powershell
ngrok http 8000
```
