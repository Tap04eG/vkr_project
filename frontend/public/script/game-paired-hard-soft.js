...
function loadLevel(level) {
    ...
    if (level === 1) {
        ...
        levelInfoElement.textContent = 'Уровень 1 из 3';
        taskTitle.textContent = 'Распредели парные согласные по твердости/мягкости';
    } else if (level === 2) {
        currentHard = [...level2Hard];
        currentSoft = [...level2Soft];
        levelInfoElement.textContent = 'Уровень 2 из 3';
        taskTitle.textContent = 'Распредели парные согласные по твердости/мягкости';
    } else {
        currentHard = [...level3Hard];
        currentSoft = [...level3Soft];
        levelInfoElement.textContent = 'Уровень 3 из 3';
        taskTitle.textContent = 'Распредели оставшиеся парные согласные';
    }
    
    // Всегда по 5 букв в каждой колонке
    hardDropzone.dataset.max = '5';
    softDropzone.dataset.max = '5';
    hardCountElement.textContent = 'Твердых: 0/5';
    softCountElement.textContent = 'Мягких: 0/5';
...
function updateCounters() {
    ...
    hardCountElement.textContent = `Твердых: ${hardCount}/5`;
    softCountElement.textContent = `Мягких: ${softCount}/5`;
...
function checkLevelDistribution() {
    ...
    hardLetters.forEach(letter => {
        ...
        if (isCorrect) {
            letter.style.backgroundColor = '#E1BEE7';
            letter.style.borderColor = '#7B1FA2';
        } else {
    ...
    softLetters.forEach(letter => {
        ...
        if (isCorrect) {
            ...
            letter.style.borderColor = '#388E3C';
        } else {
            letter.style.backgroundColor = '#FFCDD2';
            letter.style.borderColor = '#F44336';
            allCorrect = false;
...
function showLevelComplete() {
    const messages = [
        'Отлично! Ты правильно распределил парные согласные Б, В, Г, Д, З!',
        'Отлично! Ты правильно распределил парные согласные К, Л, М, Н, П!',
        'Отлично! Ты правильно распределил парные согласные Р, С, Т, Ф, Х!'
    ];
...
function showFinalResults() {
    isCompleted = true;
    finalRewardMessageElement.textContent = 'Поздравляем! Ты справился со всеми 15 парами согласных!';
...
function updateProgress() {
    const totalLetters = 10; // Всегда 5+5 на каждом уровне
...
exitBtn.addEventListener('click', () => {
    if (isCompleted) {
        ...
        alert('Молодец! Ты успешно распределил все 15 пар согласных по твердости/мягкости!');
    } else {
        window.parent.postMessage({ type: 'TASK_COMPLETED' }, '*');
        alert('Возвращайся, чтобы завершить все три уровня!');
    }
});
