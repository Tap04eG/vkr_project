...
export const TASK_TEMPLATES = [
    ...
    },
    {
        ...
        desc: "Найди все гласные буквы.",
        reward: 15,
        type: "selection",
        data: {
            gameTitle: "Гласные и согласные",
            items: ["А", "Б", "В", "Г", "Д", "Е", "Ё", "Ж", "З", "И", "Й", "К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ш", "Щ", "Ъ", "Ы", "Ь", "Э", "Ю", "Я"],
            correctItems: ["А", "Е", "Ё", "И", "О", "У", "Ы", "Э", "Ю", "Я"]
        }
    },
    {
        title: "Количество слогов (Слово: Машина)",
        desc: "Определите количество слогов в слове.",
        reward: 10,
        type: "input",
        data: {
    ...
    {
        title: "Установи порядок букв (Слово: Школа)",
        desc: "Расставьте буквы в правильном порядке.",
        reward: 15,
        type: "ordering",
        data: {
            targetWord: "ШКОЛА",
